// ==========================
// BEGIN: OTPAuth Library
// https://gist.github.com/tanaikech/4de7448903389e0884e2a21cd27abc86
...
(function (L, P) {
  typeof exports == "object" && typeof module != "undefined"
    ...
    : typeof define == "function" && define.amd
      ? define(["exports"], P)
      : ((L = typeof globalThis != "undefined" ? globalThis : L || self), P((L.OTPAuth = {})));
})(this, function (L) {
  "use strict";
  const P = (i) => {
    const e = new ArrayBuffer(8),
      n = new Uint8Array(e);
    let t = i;
    for (let r = 7; r >= 0 && t !== 0; r--) ((n[r] = t & 255), (t -= n[r]), (t /= 256));
    return e;
  };
  var Z = Object.freeze({ __proto__: null, createHmac: void 0, randomBytes: void 0, timingSafeEqual: void 0 });
  ...
  function _(i, e, n, t) {
    ...
    const c = e || [0],
      a = (n = n || 0) >>> 3,
      l = t === -1 ? 3 : 0;
    for (r = 0; r < i.length; r += 1) ((u = r + a), (s = u >>> 2), c.length <= s && c.push(0), (c[s] |= i[r] << (8 * (l + t * (u % 4)))));
      ...
      case "HEX":
        return function (t, r, s) {
          return (function (u, c, a, l) {
            let w, f, h, g;
            if (u.length % 2 != 0) throw new Error("String of HEX type must be in byte increments");
            const m = c || [0],
              p = (a = a || 0) >>> 3,
              A = l === -1 ? 3 : 0;
            for (w = 0; w < u.length; w += 2) {
              if (((f = parseInt(u.substr(w, 2), 16)), isNaN(f))) throw new Error("String of HEX type contains invalid characters");
        ...
        return function (t, r, s) {
          return (function (u, c, a, l, w) {
            ...
            if (c === "UTF8")
                  ...
                  f = u.charCodeAt(g),
                    ...
                    128 > f
                      ...
                      : 2048 > f
                        ...
                        : 55296 > f || 57344 <= f
                          ? h.push(224 | (f >>> 12), 128 | ((f >>> 6) & 63), 128 | (63 & f))
                          : ((g += 1),
              ...
              for (b = w === -1 ? 2 : 0, C = (c === "UTF16LE" && w !== 1) || (c !== "UTF16LE" && w === 1), g = 0; g < u.length; g += 1) {
                for (f = u.charCodeAt(g), C === !0 && ((m = 255 & f), (f = (m << 8) | (f >>> 8))), A = I + S, p = A >>> 2; H.length <= p; ) H.push(0);
                ((H[p] |= f << (8 * (b + w * (A % 4)))), (I += 2));
              }
        ...
        return function (t, r, s) {
          return (function (u, c, a, l) {
            ...
            const C = c || [0],
              ...
              H = l === -1 ? 3 : 0,
              S = u.indexOf("=");
            if (u.search(/^[a-zA-Z0-9=+/]+$/) === -1) throw new Error("Invalid character in base-64 string");
            if (((u = u.replace(/=/g, "")), S !== -1 && S < u.length)) throw new Error("Invalid '=' found in base-64 string");
            for (f = 0; f < u.length; f += 4) {
              for (m = u.substr(f, 4), g = 0, h = 0; h < m.length; h += 1) ((w = W.indexOf(m.charAt(h))), (g |= w << (18 - 6 * h)));
              for (h = 0; h < m.length - 1; h += 1) {
                for (A = b + I, p = A >>> 2; C.length <= p; ) C.push(0);
                ((C[p] |= ((g >>> (16 - 8 * h)) & 255) << (8 * (H + l * (A % 4)))), (b += 1));
              }
            }
        ...
        return function (t, r, s) {
          return (function (u, c, a, l) {
            ...
            for (f = 0; f < u.length; f += 1)
              ((w = u.charCodeAt(f)), (g = f + p), (h = g >>> 2), m.length <= h && m.push(0), (m[h] |= w << (8 * (A + l * (g % 4)))));
      ...
      case "HEX":
        return function (r) {
          return (function (s, u, c, a) {
            ...
            const g = u / 8,
              m = c === -1 ? 3 : 0;
            for (w = 0; w < g; w += 1) ((f = s[w >>> 2] >>> (8 * (m + c * (w % 4)))), (h += l.charAt((f >>> 4) & 15) + l.charAt(15 & f)));
      ...
      case "BYTES":
        return function (r) {
          return (function (s, u, c) {
            ...
            const f = u / 8,
              h = c === -1 ? 3 : 0;
            for (a = 0; a < f; a += 1) ((l = (s[a >>> 2] >>> (8 * (h + c * (a % 4)))) & 255), (w += String.fromCharCode(l)));
            return w;
          })(r, e, n);
        };
      case "ARRAYBUFFER":
        ...
        return function (r) {
          return (function (s, u, c) {
            ...
            const l = u / 8,
              ...
              f = new Uint8Array(w),
              h = c === -1 ? 3 : 0;
            for (a = 0; a < l; a += 1) f[a] = (s[a >>> 2] >>> (8 * (h + c * (a % 4)))) & 255;
            return w;
          })(r, e, n);
        };
      case "UINT8ARRAY":
        ...
        return function (r) {
          return (function (s, u, c) {
            ...
            const l = u / 8,
              w = c === -1 ? 3 : 0,
              f = new Uint8Array(l);
            for (a = 0; a < l; a += 1) f[a] = (s[a >>> 2] >>> (8 * (w + c * (a % 4)))) & 255;
            return f;
          })(r, e, n);
        };
      default:
  ...
  function z(i, e) {
    ...
    if (r % 4 != 0) {
      for (n = 0; n < s; n += 4)
        ((t = (r + n) >>> 2), (i.value[t] |= e.value[n >>> 2] << u), i.value.push(0), (i.value[t + 1] |= e.value[n >>> 2] >>> c));
      return ((i.value.length << 2) - 4 >= s + r && i.value.pop(), { value: i.value, binLen: i.binLen + e.binLen });
    }
  ...
  function K(i, e, n, t) {
    ...
    return M(e.format, e.encoding || "UTF8", n)(e.value);
  }
  let D = class {
    constructor(e, n, t) {
      const r = t || {};
    ...
    update(e) {
      ...
      const r = this.m >>> 5,
        ...
        c = s.value,
        a = u >>> 5;
      for (n = 0; n < a; n += r) t + this.m <= u && ((this.R = this.U(c.slice(n, n + r), this.R)), (t += this.m));
      return ((this.A += t), (this.h = c.slice(t >>> 5)), (this.u = u % this.m), (this.l = !0), this);
    }
    getHash(e, n) {
      let t,
        r,
      ...
      for (r = this.g(this.h.slice(), this.u, this.A, this.B(this.R), s), t = 1; t < this.numRounds; t += 1)
        (this.K && s % 32 != 0 && (r[r.length - 1] &= 16777215 >>> (24 - (s % 32))), (r = this.g(r, s, 0, this.L(this.o), s)));
      return c(r);
    }
    setHMACKey(e, n, t) {
      if (!this.M) throw new Error("Variant does not support HMAC");
      if (this.l) throw new Error("Cannot set MAC key after calling update");
      const r = M(n, (t || {}).encoding || "UTF8", this.T);
      this.k(r(e));
    }
    k(e) {
      const n = this.m >>> 3,
      ...
      for (n < e.binLen / 8 && (e.value = this.g(e.value, e.binLen, 0, this.L(this.o), this.v)); e.value.length <= t; ) e.value.push(0);
      for (r = 0; r <= t; r += 1) ((this.S[r] = 909522486 ^ e.value[r]), (this.p[r] = 1549556828 ^ e.value[r]));
  ...
  function oe(i, e) {
    let n, t, r, s, u, c, a;
    const l = [];
    for (n = e[0], t = e[1], r = e[2], s = e[3], u = e[4], a = 0; a < 80; a += 1)
      ((l[a] = a < 16 ? i[a] : k(l[a - 3] ^ l[a - 8] ^ l[a - 14] ^ l[a - 16], 1)),
        (c =
          a < 20
            ? Y(k(n, 5), ie(t, r, s), u, 1518500249, l[a])
            : a < 40
              ? Y(k(n, 5), re(t, r, s), u, 1859775393, l[a])
              : a < 60
                ? Y(k(n, 5), se(t, r, s), u, 2400959708, l[a])
                : Y(k(n, 5), re(t, r, s), u, 3395469782, l[a])),
        (u = s),
        (s = r),
        (r = k(t, 30)),
        (t = n),
        (n = c));
    return ((e[0] = y(n, e[0])), (e[1] = y(t, e[1])), (e[2] = y(r, e[2])), (e[3] = y(s, e[3])), (e[4] = y(u, e[4])), e);
  }
  function Ee(i, e, n, t) {
    let r;
    const s = 15 + (((e + 65) >>> 9) << 4),
    ...
    for (i[e >>> 5] |= 128 << (24 - (e % 32)), i[s] = 4294967295 & u, i[s - 1] = (u / 4294967296) | 0, r = 0; r < i.length; r += 16)
  ...
  function he(i, e) {
    ...
    const g = [];
    for (n = e[0], t = e[1], r = e[2], s = e[3], u = e[4], c = e[5], a = e[6], l = e[7], h = 0; h < 64; h += 1)
      ...
      ((this.F = this.Y),
        ...
        (this.g = function (s, u, c, a) {
          return (function (l, w, f, h, g) {
            ...
            for (l[w >>> 5] |= 128 << (24 - (w % 32)), l[A] = 4294967295 & b, l[A - 1] = (b / 4294967296) | 0, m = 0; m < l.length; m += 16)
              h = he(l.slice(m, m + 16), h);
            return ((p = g === "SHA-224" ? [h[0], h[1], h[2], h[3], h[4], h[5], h[6]] : h), p);
          })(s, u, c, a, e);
        }),
        (this.R = ue(e)),
        (this.m = 512),
  ...
  function ae(i, e) {
    let n;
    return e > 32
      ? ((n = 64 - e), new o((i.I << e) | (i.N >>> n), (i.N << e) | (i.I >>> n)))
      : e !== 0
        ? ((n = 32 - e), new o((i.N << e) | (i.I >>> n), (i.I << e) | (i.N >>> n)))
        : i;
  }
  function T(i, e) {
    let n;
  ...
  function Te(i, e, n, t) {
    ...
    return (
      (r = (65535 & i.N) + (65535 & e.N) + (65535 & n.N) + (65535 & t.N) + (s >>> 16)),
  ...
  function Ue(i, e, n, t, r) {
    ...
    return (
      (s = (65535 & i.N) + (65535 & e.N) + (65535 & n.N) + (65535 & t.N) + (65535 & r.N) + (u >>> 16)),
  ...
  function fe(i, e) {
    ...
    const m = [];
    for (n = e[0], t = e[1], r = e[2], s = e[3], u = e[4], c = e[5], a = e[6], l = e[7], h = 0; h < 80; h += 1)
      (h < 16 ? ((g = 2 * h), (m[h] = new o(i[g], i[g + 1]))) : (m[h] = Te(Ce(m[h - 2]), m[h - 7], Le(m[h - 15]), m[h - 16])),
        (w = Ue(l, $e(u), ((A = c), (b = a), new o(((p = u).N & A.N) ^ (~p.N & b.N), (p.I & A.I) ^ (~p.I & b.I))), Be[h], m[h])),
        (f = N(Re(n), Se(n, t, r))),
        (l = a),
        (a = c),
        (c = u),
        ...
        (this.g = function (s, u, c, a) {
          return (function (l, w, f, h, g) {
            ...
            const A = 31 + (((w + 129) >>> 10) << 5),
              b = w + f;
            for (; l.length <= A; ) l.push(0);
            for (l[w >>> 5] |= 128 << (24 - (w % 32)), l[A] = 4294967295 & b, l[A - 1] = (b / 4294967296) | 0, m = 0; m < l.length; m += 32)
              h = fe(l.slice(m, m + 32), h);
            return (
              (p =
                g === "SHA-384"
                  ? [h[0].N, h[0].I, h[1].N, h[1].I, h[2].N, h[2].I, h[3].N, h[3].I, h[4].N, h[4].I, h[5].N, h[5].I]
                  : [h[0].N, h[0].I, h[1].N, h[1].I, h[2].N, h[2].I, h[3].N, h[3].I, h[4].N, h[4].I, h[5].N, h[5].I, h[6].N, h[6].I, h[7].N, h[7].I]),
              p
            );
          })(s, u, c, a, e);
        }),
  ...
  function V(i) {
    let e;
    const n = [];
    for (e = 0; e < 5; e += 1) n[e] = [new o(0, 0), new o(0, 0), new o(0, 0), new o(0, 0), new o(0, 0)];
    return n;
  }
  function ke(i) {
    let e;
  ...
  function q(i, e) {
    ...
    const u = [],
      c = [];
    if (i !== null)
      for (t = 0; t < i.length; t += 2) e[(t >>> 1) % 5][((t >>> 1) / 5) | 0] = x(e[(t >>> 1) % 5][((t >>> 1) / 5) | 0], new o(i[t + 1], i[t]));
    for (n = 0; n < 24; n += 1) {
      for (s = V(), t = 0; t < 5; t += 1)
        u[t] =
          ((a = e[t][0]),
      ...
      for (t = 0; t < 5; t += 1) c[t] = x(u[(t + 4) % 5], ae(u[(t + 1) % 5], 1));
      for (t = 0; t < 5; t += 1) for (r = 0; r < 5; r += 1) e[t][r] = x(e[t][r], c[t]);
      for (t = 0; t < 5; t += 1) for (r = 0; r < 5; r += 1) s[r][(2 * t + 3 * r) % 5] = ae(e[t][r], Me[t][r]);
      for (t = 0; t < 5; t += 1)
        for (r = 0; r < 5; r += 1)
  ...
  function we(i) {
    ...
    for (e = 6; e >= 0; e--) ((n = (s[e >> 2] >>> (8 * e)) & 255), (n === 0 && t === 0) || ((r[(t + 1) >> 2] |= n << (8 * (t + 1))), (t += 1)));
    return ((t = t !== 0 ? t : 1), (r[0] |= t), { value: t + 1 > 4 ? r : [r[0]], binLen: 8 + 8 * t });
  }
  function J(i) {
  ...
  class Pe extends D {
    constructor(e, n, t) {
      ...
      const u = t || {};
      if (this.numRounds !== 1) {
        if (u.kmacKey || u.hmacKey) throw new Error("Cannot set numRounds with MAC");
        if (this.o === "CSHAKE128" || this.o === "CSHAKE256") throw new Error("Cannot set numRounds for CSHAKE variants");
      }
      switch (((this.T = 1), (this.C = M(this.t, this.i, this.T)), (this.U = q), (this.B = ke), (this.L = V), (this.R = V()), (this.K = !1), e)) {
        case "SHA3-224":
        ...
        case "SHA3-512":
          ...
          break;
        case "SHAKE128":
          ((r = 31), (this.m = s = 1344), (this.v = -1), (this.K = !0), (this.M = !1), (this.F = null));
          break;
        case "SHAKE256":
          ((r = 31), (this.m = s = 1088), (this.v = -1), (this.K = !0), (this.M = !1), (this.F = null));
          break;
        case "KMAC128":
          ((r = 4), (this.m = s = 1344), this.X(t), (this.v = -1), (this.K = !0), (this.M = !1), (this.F = this._));
          break;
        case "KMAC256":
          ((r = 4), (this.m = s = 1088), this.X(t), (this.v = -1), (this.K = !0), (this.M = !1), (this.F = this._));
          break;
        case "CSHAKE128":
          ((this.m = s = 1344), (r = this.O(t)), (this.v = -1), (this.K = !0), (this.M = !1), (this.F = null));
          break;
        case "CSHAKE256":
          ((this.m = s = 1088), (r = this.O(t)), (this.v = -1), (this.K = !0), (this.M = !1), (this.F = null));
          break;
        default:
          throw new Error(O);
      }
      ((this.g = function (c, a, l, w, f) {
        return (function (h, g, m, p, A, b, C) {
          ...
          const j = [],
            G = A >>> 5,
            ot = g >>> 5;
          for (I = 0; I < ot && g >= A; I += G) ((p = q(h.slice(I, I + G), p)), (g -= A));
          for (h = h.slice(I), g %= A; h.length < G; ) h.push(0);
          for (
            I = g >>> 3, h[I >> 2] ^= b << ((I % 4) * 8), h[G - 1] ^= 2147483648, p = q(h, p);
            32 * j.length < C && ((H = p[S % 5][(S / 5) | 0]), j.push(H.I), !(32 * j.length >= C));
          )
    ...
    O(e, n) {
      const t = (function (s) {
        ...
        return {
          ...
          customization: K("Customization", u.customization, 1, { value: [], binLen: 0 }),
        };
      })(e || {});
      n && (t.funcName = n);
      ...
      if (t.customization.binLen !== 0 || t.funcName.binLen !== 0) {
        ...
        for (let u = 0; u < s.length; u += this.m >>> 5) ((this.R = this.U(s.slice(u, u + (this.m >>> 5)), this.R)), (this.A += this.m));
        return 4;
      }
      return 31;
    }
    X(e) {
      const n = (function (r) {
        ...
        return {
          ...
          customization: K("Customization", s.customization, 1, { value: [], binLen: 0 }),
        };
      })(e || {});
      this.O(e, n.funcName);
      const t = de(J(n.kmacKey), this.m >>> 3);
      for (let r = 0; r < t.length; r += this.m >>> 5) ((this.R = this.U(t.slice(r, r + (this.m >>> 5)), this.R)), (this.A += this.m));
      this.H = !0;
    }
    _(e) {
      const n = z(
        ...
        (function (t) {
          ...
          for (r = 6; r >= 0; r--) ((s = (a[r >> 2] >>> (8 * r)) & 255), (s === 0 && u === 0) || ((c[u >> 2] |= s << (8 * u)), (u += 1)));
          return ((u = u !== 0 ? u : 1), (c[u >> 2] |= u << (8 * u)), { value: u + 1 > 4 ? c : [c[0]], binLen: 8 + 8 * u });
        })(e.outputLen),
      );
  ...
  const F = (() => {
    ...
    xe = (i, e, n) => {
      Z != null;
      {
        ...
        if (typeof t == "undefined") throw new TypeError("Unknown hash function");
        const r = new Oe(t, "ARRAYBUFFER");
        return (r.setHMACKey(e, "ARRAYBUFFER"), r.update(n), r.getHMAC("ARRAYBUFFER"));
      }
    },
    Xe = (i, e) => {
      let n = "",
    ...
    ze = (i) => {
      ...
      let n = 0,
        t = 0,
        r = "";
      for (let s = 0; s < e.length; s++) for (t = (t << 8) | e[s], n += 8; n >= 5; ) ((r += Q[(t >>> (n - 5)) & 31]), (n -= 5));
    ...
    ge = F.TextEncoder ? new F.TextEncoder("utf-8") : null,
    me = F.TextDecoder ? new F.TextDecoder("utf-8") : null,
    Ve = (i) => {
    ...
    Qe = (i) => {
      if ((Z != null, !F.crypto || !F.crypto.getRandomValues)) throw new Error("Cryptography API not available");
      return F.crypto.getRandomValues(new Uint8Array(i)).buffer;
    };
  class U {
    constructor() {
      let { buffer: e, size: n = 20 } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
      this.buffer = typeof e == "undefined" ? Qe(n) : e;
    }
    static fromLatin1(e) {
      return new U({ buffer: Ge(e) });
    }
    static fromUTF8(e) {
      return new U({ buffer: Ve(e) });
    }
    static fromBase32(e) {
      return new U({ buffer: je(e) });
    }
    static fromHex(e) {
      return new U({ buffer: De(e) });
    }
    get latin1() {
      return (Object.defineProperty(this, "latin1", { enumerable: !0, value: Ze(this.buffer) }), this.latin1);
    }
    get utf8() {
      return (Object.defineProperty(this, "utf8", { enumerable: !0, value: Je(this.buffer) }), this.utf8);
    }
    get base32() {
      return (Object.defineProperty(this, "base32", { enumerable: !0, value: ze(this.buffer) }), this.base32);
    }
    get hex() {
      return (Object.defineProperty(this, "hex", { enumerable: !0, value: qe(this.buffer) }), this.hex);
    }
  }
  const We = (i, e) => {
    Z != null;
    {
      if (i.length !== e.length) throw new TypeError("Input strings must have the same length");
      let n = -1,
        t = 0;
  ...
  let X = class v {
    static get defaults() {
      return { issuer: "", label: "OTPAuth", algorithm: "SHA1", digits: 6, counter: 0, window: 1 };
    }
    constructor() {
      let {
    ...
    static generate(e) {
      ...
      const u = new Uint8Array(xe(t, n.buffer, P(s))),
        ...
        a = (((u[c] & 127) << 24) | ((u[c + 1] & 255) << 16) | ((u[c + 2] & 255) << 8) | (u[c + 3] & 255)) % _e(10, r);
      return Xe(a, r);
    }
    generate() {
      let { counter: e = this.counter++ } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
      return v.generate({ secret: this.secret, algorithm: this.algorithm, digits: this.digits, counter: e });
    }
    static validate(e) {
      ...
      for (let l = u - c; l <= u + c; ++l) {
        const w = v.generate({ secret: t, algorithm: r, digits: s, counter: l });
        We(n, w) && (a = l - u);
      }
      return a;
    }
    validate(e) {
      ...
      return v.validate({ token: n, secret: this.secret, algorithm: this.algorithm, digits: this.digits, counter: t, window: r });
    }
    toString() {
      const e = encodeURIComponent;
      return `otpauth://hotp/${
        this.issuer.length > 0 ? `${e(this.issuer)}:${e(this.label)}?issuer=${e(this.issuer)}&` : `${e(this.label)}?`
      }secret=${e(this.secret.base32)}&algorithm=${e(this.algorithm)}&digits=${e(this.digits)}&counter=${e(this.counter)}`;
    }
  };
  class E {
    static get defaults() {
      return { issuer: "", label: "OTPAuth", algorithm: "SHA1", digits: 6, period: 30, window: 1 };
    }
    constructor() {
      let {
    ...
    static generate(e) {
      ...
      return X.generate({ secret: n, algorithm: t, digits: r, counter: Math.floor(u / 1e3 / s) });
    }
    generate() {
      let { timestamp: e = Date.now() } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
      return E.generate({ secret: this.secret, algorithm: this.algorithm, digits: this.digits, period: this.period, timestamp: e });
    }
    static validate(e) {
      let { token: n, secret: t, algorithm: r, digits: s, period: u = E.defaults.period, timestamp: c = Date.now(), window: a } = e;
      return X.validate({ token: n, secret: t, algorithm: r, digits: s, counter: Math.floor(c / 1e3 / u), window: a });
    }
    validate(e) {
  ...
  const et = /^otpauth:\/\/([ht]otp)\/(.+)\?([A-Z0-9.~_-]+=[^?&]*(?:&[A-Z0-9.~_-]+=[^?&]*)*)$/i,
    tt = /^[2-7A-Z]+=*$/i,
    nt = /^SHA(?:1|224|256|384|512|3-224|3-256|3-384|3-512)$/i,
    rt = /^[+-]?\d+$/,
    pe = /^\+?[1-9]\d*$/;
  class it {
    static parse(e) {
      ...
      const c = {};
      if (t === "hotp")
        if (((u = X), typeof s.counter != "undefined" && rt.test(s.counter))) c.counter = parseInt(s.counter, 10);
      ...
      if (
        (r.length === 2 ? ((c.label = r[1]), (c.issuer = r[0])) : ((c.label = r[0]), typeof s.issuer != "undefined" && (c.issuer = s.issuer)),
        typeof s.secret != "undefined" && tt.test(s.secret))
      )
        c.secret = s.secret;
      else throw new TypeError("Missing or invalid 'secret' parameter");
      if (typeof s.algorithm != "undefined")
        if (nt.test(s.algorithm)) c.algorithm = s.algorithm;
  ...
  const st = "9.1.1";
  ((L.HOTP = X), (L.Secret = U), (L.TOTP = E), (L.URI = it), (L.version = st));
});
